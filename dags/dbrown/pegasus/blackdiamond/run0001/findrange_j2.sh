...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "gsiftp://sugwg-condor.phy.syr.edu/home/dbrown/projects/osg/condor-blackdiamond-container/local-site-scratch/dbrown/pegasus/blackdiamond/run0001/./centos-pycbc", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "condorpool", "url": "file://$PWD/centos-pycbc", "type": "singularity" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "input",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "local", "url": "gsiftp://sugwg-condor.phy.syr.edu/home/dbrown/projects/osg/condor-blackdiamond-container/local-site-scratch/dbrown/pegasus/blackdiamond/run0001/./f.b1", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "condorpool", "url": "file://$PWD/f.b1" }
   ] }
]
EOF
...
pegasus-integrity --print-timings --verify=f.b1 1>&2

set +e
job_ec=0
echo -e "\n#########################[Container] Launching user task #########################"  1>&2

pegasus-kickstart  -n pegasus::findrange:4.0 -N j2 -R condorpool  -s f.c1=f.c1 -L blackdiamond -T 2018-10-23T16:55:04-04:00 /usr/bin/pegasus-keg -a findrange -T 60 -i f.b1 -o f.c1
EOF


chmod +x findrange_j2-cont.sh
...
singularity exec --pwd /srv --home $PWD:/srv centos-pycbc ./findrange_j2-cont.sh 
job_ec=$(($job_ec + $?))
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "condorpool", "url": "file://$PWD/f.c1", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "local", "url": "gsiftp://sugwg-condor.phy.syr.edu/home/dbrown/projects/osg/condor-blackdiamond-container/local-site-scratch/dbrown/pegasus/blackdiamond/run0001/./f.c1" }
   ] }
]
EOF
